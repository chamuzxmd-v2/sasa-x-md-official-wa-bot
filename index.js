...
async function connectToWA() {
  console.log("Connecting SASA X MD 🧬...");
  ...
  danuwa.ev.on('connection.update', async (update) => {
    ...
    if (connection === 'close') {
      ...
      console.log('✅ SASA X MD connected to WhatsApp');

      const up = `SASA X MD CONNECTED SUCCESSFULLY! 😝🀄\n\nPREFIX: ${prefix}`;
      await danuwa.sendMessage(ownerNumber[0] + "@s.whatsapp.net", {
        image: { url: `https://i.ibb.co/DPd51BK7/2c47d62ecc68.jpg` },
        caption: up
      });
...
app.get("/", (req, res) => {
  res.send("HEY SASA X MD STARTED ✅");
});
